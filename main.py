...
# TO DO:
# In this main.py that will have the main menu, list all of your team members
# and include an exit option. When a member a selected, it will execute their
# 'menu()'. It will stay accessible until the user chooses to exit the 
